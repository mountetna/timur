MfiHeatmapPlotContainer = React.createClass({
  ...
  componentWillMount: function() {
    ...
    store.dispatch(
      plotActions.updateRequestedMappings(
        this.props.plot.plot_id, Object.keys(this.props.default_mfi_mappings)
      )
    );
  },
  render: function() {
...
MfiHeatmapPlotContainer.contextTypes = {
  store: React.PropTypes.object
};

module.exports =MfiHeatmapPlotContainer;
