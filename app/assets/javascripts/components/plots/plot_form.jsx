...
import { Plot } from '../../selectors/plot'

class PlotForm extends Component {
  constructor(props) {
    super(props);

    this.plot = props.plot || new Plot()
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.consignment != this.props.consignment) {
      ...
      this.setState({ referenceableTables: nextProps.consignment ? this.referenceableTables(nextProps.consignment) : {} });
    }
  ...
  addSeries(series) {
    const withSeriesData = {
      ...
      manifestSeriesHoverText: series.hovertext,
      hovertext: this.state.plotableData[series.hovertext] ? this.state.plotableData[series.hovertext].values : []
    };
