  ...
  def apply_template!
    ...
    patch_key :fingerprint do |sum|
      ...
      [
        ...
        { series: "CD4+",
          height: get_count(@record.nktb_stain, :cd4_count) / nk_live_count.to_f
        },
        { series: "CD8+",
          height: get_count(@record.nktb_stain, :cd8_count) / nk_live_count.to_f
        },
        { series: "T-regs",
          height: get_count(@record.treg_stain, :treg_count) / treg_live_count.to_f
        },
        { series: "BDCA1+ DCs",
