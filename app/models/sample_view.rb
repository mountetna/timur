          ...
          manifest: [
            ...
            [ :fingerprint, "table(
              ...
              [
                ...
                dc_lineage_count: [ 'population', [ 'stain', '::equals', 'dc' ], [ 'name', '::equals', 'Lymphocytes+' ], '::first', 'count' ],
                dc_hladr_count: [ 'population', [ 'stain', '::equals', 'dc' ], [ 'name', '::equals', 'HLADR+,Lymphocytes-' ], '::first', 'count' ],
