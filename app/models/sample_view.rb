          ...
          manifest: [
            ...
            [ :fingerprint, "table(
              ...
              [
                ...
                dc_lineage_count: [ 'population', ['stain', '::equals', 'dc'],['name', '::in', ['Lymphocytes+', 'Lineage+'] ], '::first', 'count' ],
                dc_hladr_count: [ 'population', ['stain', '::equals', 'dc'], ['name', '::in', ['HLADR+,Lymphocytes-', 'HLADR+'] ], '::first', 'count' ],
