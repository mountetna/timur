class User < ActiveRecord::Base
  ...
  DEFAULT_MAPPINGS = {
    'jriqm66' => { key: 'jriqm66', stain: 'sort', name: 'Immune fraction', type: 'Population Fraction', v1: "CD45+##Live\tSingle Cells 2\tSingle Cells\tTime", v2: "Live##Single Cells 2\tSingle Cells\tTime" },
    ...
    'tgd1vc3' => { key: 'tgd1vc3', stain: 'sort', name: 'Stromal Cells 2 fraction', type: 'Population Fraction', v1: "Q1: CD90- , CD44+##CD45-\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD45-##Live\tSingle Cells 2\tSingle Cells\tTime" },
    'fex3r8l' => { key: 'fex3r8l', stain: 'sort', name: 'Stromal Cells 1 fraction', type: 'Population Fraction', v1: "Q2: CD90+ , CD44+##CD45-\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD45-##Live\tSingle Cells 2\tSingle Cells\tTime" },
    ...
    'fx1c25w' => { key: 'fx1c25w', stain: 'treg', name: 'Immune fraction', type: 'Population Fraction', v1: "CD45+##Live\tSingle Cells 2\tSingle Cells\tTime", v2: "Live##Single Cells 2\tSingle Cells\tTime" },
    '2a5w8s6' => { key: '2a5w8s6', stain: 'treg', name: 'T-cell fraction', type: 'Population Fraction', v1: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD45+##Live\tSingle Cells 2\tSingle Cells\tTime" },
    ...
    'pgbktsu' => { key: 'pgbktsu', stain: 'treg', name: 'CD4+ T-cell fraction', type: 'Population Fraction', v1: "Q1: CD8a- , CD4+##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'q8jilzt' => { key: 'q8jilzt', stain: 'treg', name: 'CD8+ T-cell fraction', type: 'Population Fraction', v1: "Q2: CD8a+ , CD4+##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    '87jj9xc' => { key: '87jj9xc', stain: 'treg', name: 'DP T-cell fraction', type: 'Population Fraction', v1: "Q3: CD8a+ , CD4-##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    '34pvk6q' => { key: '34pvk6q', stain: 'treg', name: 'DN T-cell fraction', type: 'Population Fraction', v1: "Q4: CD8a- , CD4-##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    ...
    '58uadwa' => { key: '58uadwa', stain: 'treg', name: 'CD8+ HLADR+ T-cell fraction', type: 'Population Fraction', v1: "Q2: CD8a+ , CD4+##CD3+, HLADR+\tCD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+, HLADR+##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'e6bim0s' => { key: 'e6bim0s', stain: 'treg', name: 'DP HLADR+ T-cell fraction', type: 'Population Fraction', v1: "Q3: CD8a+ , CD4-##CD3+, HLADR+\tCD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+, HLADR+##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    ...
    '9qnmcpv' => { key: '9qnmcpv', stain: 'treg', name: 'CD8+ HLADR- T-cell fraction', type: 'Population Fraction', v1: "Q2: CD8a+ , CD4+##CD3+, HLADR-\tCD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+, HLADR-##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'ljh2v88' => { key: 'ljh2v88', stain: 'treg', name: 'DP HLADR- T-cell fraction', type: 'Population Fraction', v1: "Q3: CD8a+ , CD4-##CD3+, HLADR-\tCD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+, HLADR-##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    ...
    'p23n5b9' => { key: 'p23n5b9', stain: 'nktb', name: 'T-cell fraction', type: 'Population Fraction', v1: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD45+##Live\tSingle Cells 2\tSingle Cells\tTime" },
    ...
    'ytkvy2i' => { key: 'ytkvy2i', stain: 'nktb', name: 'CD4+ T-cell fraction', type: 'Population Fraction', v1: "Q1: CD8a- , CD4+##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'x4ch024' => { key: 'x4ch024', stain: 'nktb', name: 'CD8+ T-cell fraction', type: 'Population Fraction', v1: "Q3: CD8a+ , CD4-##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'ci1ruin' => { key: 'ci1ruin', stain: 'nktb', name: 'DP T-cell fraction', type: 'Population Fraction', v1: "Q2: CD8a+ , CD4+##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'o1g0lvm' => { key: 'o1g0lvm', stain: 'nktb', name: 'DN T-cell fraction', type: 'Population Fraction', v1: "Q4: CD8a- , CD4-##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'f6ri0of' => { key: 'f6ri0of', stain: 'nktb', name: 'Q5 T-cell fraction', type: 'Population Fraction', v1: "Q5: CD56- , CD19+##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'zfoukvr' => { key: 'zfoukvr', stain: 'nktb', name: 'Q6 (NK) T-cell fraction', type: 'Population Fraction', v1: "Q6: CD56+ , CD19+##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'tunsano' => { key: 'tunsano', stain: 'nktb', name: 'Q7 (NK) T-cell fraction', type: 'Population Fraction', v1: "Q7: CD56+ , CD19-##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'djhkkid' => { key: 'djhkkid', stain: 'nktb', name: 'Q8 T-cell fraction', type: 'Population Fraction', v1: "Q8: CD56- , CD19-##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    'th6z20p' => { key: 'th6z20p', stain: 'dc', name: 'Immune fraction', type: 'Population Fraction', v1: "CD45+##Live\tSingle Cells 2\tSingle Cells\tTime", v2: "Live##Single Cells 2\tSingle Cells\tTime" },
