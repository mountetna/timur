class User < ActiveRecord::Base
  ...
  DEFAULT_MAPPINGS = {
    ...
    'uanuatp' => { key: 'uanuatp', stain: 'nktb', name: 'HLADR+ fraction', type: 'Population Fraction', v1: "HLADR+##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD45+##Live\tSingle Cells 2\tSingle Cells\tTime" },    '87njjvi' => { key: '87njjvi', stain: 'dc', name: 'Monocyte fraction', type: 'Population Fraction', v1: "CD16+ Monocytes##HLADR+\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD45+##Live\tSingle Cells 2\tSingle Cells\tTime" },
