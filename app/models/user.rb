class User < ActiveRecord::Base
  ...
  DEFAULT_MAPPINGS = {
    ...
    'q8jilzt' => { key: 'q8jilzt', stain: 'treg', name: 'CD8+ T-cell fraction(treg)', type: 'Population Fraction', v1: "Q2: CD8a+ , CD4+##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
    '87jj9xc' => { key: '87jj9xc', stain: 'treg', name: 'DP T-cell fraction(treg)', type: 'Population Fraction', v1: "Q3: CD8a+ , CD4-##CD3+ all\tCD45+\tLive\tSingle Cells 2\tSingle Cells\tTime", v2: "CD3+ all##CD45+\tLive\tSingle Cells 2\tSingle Cells\tTime" },
