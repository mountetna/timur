...
const addViewAction = (view_name, view) => ({ type: 'ADD_VIEW', view_name, view });
const loadViewsAction = (views)=>({ type: 'LOAD_VIEW', views });
...
export const requestViewsAction = (success) => (dispatch) => {
...
export const saveNewViewAction = (view, success) => (dispatch) =>
