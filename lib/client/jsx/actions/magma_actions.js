...
export const addTemplate = (template_name, template)=>{
  return {
    type: 'ADD_TEMPLATE',
 ...
 */
export const consumePayload = (dispatch, response, project_name)=>{
  if(response.models){
...
export const requestDocuments = (args, project_name = TIMUR_CONFIG.project_name)=>{
  let {
    model_name,
    record_names,
    attribute_names,
