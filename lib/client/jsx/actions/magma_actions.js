...
export const DISCARD_ATTRIBUTE_REVISION = 'DISCARD_ATTRIBUTE_REVISION';
...
export const discardAttributeRevision = (record_name, model_name, attribute_name) => {
  return {
    type: DISCARD_ATTRIBUTE_REVISION,
    model_name,
    record_name,
    attribute_name
  };
