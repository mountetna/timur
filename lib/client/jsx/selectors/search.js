...
export const selectSearchExpandMatrices = createSelector(
  selectSearchData,
  (search) => search.expand_matrices
);

export const selectSearchTransposeTsv = createSelector(
  selectSearchData,
  (search) => search.transpose_tsv
);
